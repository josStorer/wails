...
```go
    ...
    FileMenu.AddText("Quit", keys.CmdOrCtrl("q"), func(_ *menu.CallbackData) {
        // `rt` is an alias of "github.com/josStorer/wails/v2/pkg/runtime" to prevent collision with standard package
        rt.Quit(app.ctx)
    })
...
an Accelerator as a combination or key + [Modifier](#modifier). They are available in the `"github.com/josStorer/wails/v2/pkg/menu/keys"` package.
