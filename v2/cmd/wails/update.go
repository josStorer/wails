...
import (
	...
	"github.com/josStorer/wails/v2/internal/shell"
	"github.com/labstack/gommon/color"
	"github.com/pterm/pterm"

	"github.com/josStorer/wails/v2/internal/github"
)
...
func updateToVersion(targetVersion *github.SemanticVersion, force bool, currentVersion string) error {
	...
	sout, serr, err := shell.RunCommand(homeDir, "go", "install", "github.com/josStorer/wails/v2/cmd/wails@"+desiredVersion)
	if err != nil {
	...
	pterm.Println(color.Green("  require github.com/josStorer/wails/v2 " + desiredVersion))
